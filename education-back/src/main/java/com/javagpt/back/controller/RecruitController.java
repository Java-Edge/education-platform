...
public class RecruitController {
    ...
    public ResultBody getByPage(Integer current, Integer size, HttpServletRequest request) {
        Page<com.javagpt.back.entity.Recruit> page = recruitService.selectPage(current, size, request);
        return ResultBody.success(page);
    }

    @PostMapping("/selectByCondition")
    public ResultBody list(@RequestBody PageQueryParam<Recruit> pageQueryParam, HttpServletRequest request) {
    ...
    @PostMapping("/save")
    public ResultBody save(@RequestBody com.javagpt.back.entity.Recruit recruit) {
    ...
    public ResultBody hotRecruits() {
        List<com.javagpt.back.entity.Recruit> hotRecruits = recruitService.getHotRecruits();
