...
public class RecruitData {
    ...
    private Long addInternRecruit;
    private Long allowDeliverCount;
    private Object apiActSpecialActivity;
    private ApiSimpleBossUser apiSimpleBossUser;
    private Long autoInviteSwitch;
    private Long avgProcessDay;
    private Long avgProcessRate;
    private Long avgProcessSec;
